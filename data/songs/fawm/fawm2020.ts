...
export const fawm2020 = [
  ...
  },
  {
     ...
     "credits": [ ],
     "date": "2020-02",
     "description": "Was wanting to do my yearly DADGAD song late one night when I got the idea for this one, but it had more of a morning feel to it so I waited until the next morning to write it!\n",
     "duration": 220,
     "link": "labour_of_love",
     "name": "Labour of Love",
     "sections": [ ],
  ...
  },
  {
     ...
     "duration": 282,
     "link": "trafilata_al_bronzo",
     "name": "Trafilata al Bronzo",
     "sections": [ ],
     "sheetMusic": false,
     "video": false
  },
  ...
  },
  {
     ...
     "duration": 806,
     "link": "rhapsody_of_uncertainty",
     "name": "Rhapsody of Uncertainty",
     "sections": [ ],
     "sheetMusic": true,
     "video": false
  },
  {
     ...
     "credits": [ ],
     "date": "2020-02",
     "description": "8 minutes cut out of a 30 minute improv session. It sounded so much like a piece already composed that I decided to upload it verbatim here. Will probably go back and give it some more coherence at some point.\n\nMultiple (3 or 4) themes from this same improv session went on to become [[song:demos.fawm_2020.rhapsody_of_uncertainty|Rhapsody of Uncertainty]].\n",
     "duration": 484,
     "link": "impromptu_1",
     "name": "Impromptu 1",
     "sections": [ ],
  ...
  },
  {
     ...
     "credits": [ ],
     "date": "2020-02",
     "description": "My morning songs always seem to end up happier than my other songs. Its weird considering that I usually write them before I have my coffee...\nI just picture dancing skeletons when listening to this, and there's definitely some Garcia and Grisman influence poking through. Hence the title.\n",
     "duration": 288,
     "link": "dance_of_the_dead",
  ...
  },
  {
     ...
     "credits": [
        {
           "role": "Vocals, Guitar, Bass Guitar, Music",
           "who": "Andrew Russell"
        },
        {
           "role": "Vocals, Lyrics",
