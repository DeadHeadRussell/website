...
utils.makeAlbum(
  ...
  [
    ...
    utils.makeSong(
      ...
      credits = [
        ...
        utils.makeCredit('Sean Brennan', 'Piano')
      ],
      lyrics = |||
    ...
    utils.makeSong(
      ...
      credits = [
        utils.makeCredit('Andrew Russell', 'Vocals, Guitar, Music, Lyrics'),
        utils.makeCredit('Sean Brennan', 'Vocals, Bass'),
      ],
      lyrics = |||
        [Verse 1]
    ...
    utils.makeSong(
      ...
      credits = [
        utils.makeCredit('Andrew Russell', 'Vocals, Guitar, Music, Lyrics'),
        utils.makeCredit('Sean Brennan', 'Vocals, Viola')
      ],
      lyrics = |||
        [V1]
    ...
    utils.makeSong(
      ...
      artist = 'Lavish Dude',
      credits = [
        utils.makeCredit('Sean Brennan', 'Vocals, Viola, Bass, Music, Lyrics'),
        utils.makeCredit('Andrew Russell', 'Guitar')
      ],
      lyrics = |||
    ...
    utils.makeSong(
      ...
      artist = 'Lavish Dude',
      credits = [
        utils.makeCredit('Andrew Russell', 'Piano, Drums, Music'),
        utils.makeCredit('Sean Brennan', 'Viola, Bass')
      ]
    ),
    utils.makeSong(
      'Cracked Aces',
      ...
      credits = [
        utils.makeCredit('Sean Brennan', 'Vocals, Viola, Music, Lyrics'),
        utils.makeCredit('Andrew Russell', 'Guitar, Piano')
      ],
      lyrics = |||
        [Verse 1]
  ...
  description = |||
    [[category:lavish_dude|Lavish Dude]] is myself and Sean Brennan kicking ass. Songs are all demos written during FAWM.
  |||,
