...
utils.makeAlbum(
  ...
  [
    ...
    utils.makeSong(
      ...
      '2017-02',
      1580,
      description = 'Part three of the improv tour.  This time the electric guitar makes it\'s appearance.  This is probably my least favourite of the bunch, but has churned out one of my favourites in [[song:solo_projects.misc.the_pensive_pest|The Pensive Pest]].'
    ),
    utils.makeSong(
