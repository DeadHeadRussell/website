...
var CreateMusicPage = function() {
  ...
  for(var i = 0; i < data.artists.length; i++) {
    ...
    aImg.src = '/data/images/artists/' + artist.name + '/main.jpg';
    aImg.alt = '';
  ...
  for(var i = 0; i < data.equipment.length; i++) {
    ...
    var equipment = {
      ...
      imgSrc: '/data/images/equipment/' + e.name + '/main.jpg'
    };
    ...
    for(var j = 0; j < e.equipment.length; j++) {
      ...
      var img = document.createElement('Img');
      img.src = '/data/images/equipment/' + e.name + '/' + ee.name + '.jpg';
      ...
      tiles.push({
        ...
        imgSrc: '/data/images/equipment/' + e.name + '/' + ee.name + '.jpg',
        content: largeImage,
        type: e.name
      });
    }
...
var CreateSoftPage = function() {
  ...
  for(var i = 0; i < data.softwareProjects.length; i++) {
    ...
    var project = {
      ...
      imgSrc: '/data/images/personalProjects/' + p.name + '.png'
    };
  ...
  var obj = {
    ...
    changeSubPage: function(subPages, samePage, noState) {
      ...
      obj.subPages = subPages;
      if(!noState) {
        pages.pushState('software', obj.subPages);
      }
    }
  };
...
var CreateResumesPage = function() {
  ...
  for (var i = 0; i < data.resumes.length; i++) {
    ...
    var createDocLink = function(type) {
      var link = document.createElement('A');
      link.href = '/data/resumes/' + resume.name + '/full.' + type.toLowerCase();
      link.target = '_blank';
